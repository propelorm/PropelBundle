...
* The `1.3` branch contains Propel *1.6* integration for Symfony *>2.3* (*currently 2.4 and master branch*).
...
* If you depend on Symfony `2.4` or `master` branch, switch to the `1.3` branch.
